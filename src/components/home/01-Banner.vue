  ...
  <section class="banner-section py-5 position-relative overflow-hidden" style="background-color: #ffffff;">
    <div class="container py-lg-4">
      <div class="row align-items-center mb-5">
        ...
        <div class="col-lg-6 col-md-12 text-center">
          <div class="banner-image-container p-2">
            <img 
              src="/img/home/IMAGEN_1_SECCION_1.png" 
              alt="PBX Hosting Soluciones" 
      ...
      <div class="d-flex flex-column flex-md-row gap-4 gap-lg-5 justify-content-center justify-content-lg-start pt-0">
        ...
        <FeatureItem 
          icono="/img/home/ICONO_1_SECCIO_1.png" 
          titulo="Soporte especializado las 24 horas." 
        />
        <FeatureItem 
          icono="/img/home/ICONO_2_SECCIO_1.png" 
          titulo="Infraestructura confiable" 
        />
        <FeatureItem 
          icono="/img/home/ICONO_3_SECCIO_1.png" 
          titulo="Comunicación sin límites" 
        />
