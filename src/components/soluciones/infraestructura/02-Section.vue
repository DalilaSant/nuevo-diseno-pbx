...
<template>
    <section class="switch-pricing-section py-0 mt-lg-4">
        <div class="container pt-lg-4">

            <!-- Título de la Sección -->
            <h2 class="section-title text-center fw-semibold mb-1 text-dark">
                Paquetes Hosting
            </h2>
            <h2 class="section-title-dos text-center fw-semibold mb-5 text-dark">
                EN DOMINIOS <span class="text-red">.COM Y .COM.MX</span>
            </h2>

            <!-- Fila de Tarjetas de Precios -->
            <div class="row g-4 justify-content-center">

                <div v-for="(card, index) in solucionesData.preciosHosting" :key="index"
                    class="col-xl-4 col-lg-4 col-md-6 col-12 d-flex justify-content-center">
                    <div
                        class="pricing-switch-card py-4 px-xl- px-4  rounded-4 shadow-sm d-flex flex-column justify-content-between text-start w-100">
                        <div>
                            ...
                            <div class="d-flex align-items-center gap-1 mb-3">
                                <div
                                    ...
                                    <img src="/img/soluciones/ICONO_2_SECCIO_6.png" alt="Icono"
                            ...
                            <div class="price-block text-center my-3">
                                <span class="price-period-top text-start   d-block mb-0">Anual</span>
                                <div
                                    class="price-container d-inline-flex align-items-center justify-content-center gap-1">
                            ...
                            <div class="d-flex justify-content-center w-100 mb-4">
                                <div class="features-list d-inline-flex flex-column gap-2 text-start">
                                    <div v-for="(feature, fIndex) in card.features" :key="fIndex"
                                        class="feature-item d-flex align-items-center gap-2">
                        ...
                        <!-- Botón de acción (Ahora fuera del div superior, alineado al fondo gracias a flex-column y mt-auto) -->
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-12">
                        <p class="text-center description">
                            Para más información, consulta a tu agente de ventas*
                        </p>
                    </div>
                </div>
            </div>
