...
<template>
  <section class="switch-pricing-section py-5 py-lg-1 py-xl-5 my-lg-0">
    <div class="container py-lg-5">
      ...
      <div class="row g-4 justify-content-center">
        ...
        <div v-for="(card, index) in solucionesData.preciosCallcenter" :key="index"
            ...
            <div>
              ...
              <div class="d-flex align-items-center gap-1 mb-4">
                <div class="card-icon-wrapper flex-shrink-0 d-flex align-items-center justify-content-center">
                  ...
                  <img src="/img/soluciones/ICONO_18_SECCIO_2.png" alt="Icono" class="img-fluid card-icon-img" />
                </div>
                <div>
                  <span class="card-category d-block text-dark fw-bold uppercase">{{ card.title
                    }}</span>
                </div>
              </div>
              ...
              <div class="d-flex justify-content-center w-100 mb-4">
                <div class="features-list d-inline-flex flex-column gap-2 text-start">
                  ...
                  <div class="ms-4 lh-1" v-for="(featuredesc, fIndex) in card.featuredesc" :key="fIndex">
                    <span class=" feature-text-ul fw-medium text-secondary ">{{ featuredesc }}</span>
              ...
              <!-- Botón de acción -->
              <div class="d-flex justify-content-start boton-action mt-2">
