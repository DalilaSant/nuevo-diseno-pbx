...
import { benefitsAgenteIA, benefitsWhatsapp } from '@/data/benefits-bar'
...
<template>
  <section class="pt-5 pb-3">
          ...
          <div class="row align-items-center g-4">
            ...
            <div class="col-lg-8 col-12 text-center text-lg-start mb-4 mb-lg-0" v-motion-slide-left :delay="200"
              ...
              <SectionTitleTwo textColor="text-white" displayFont="display-4" lineHeight="lh-1" marginBotton="mb-3"
               ...
               Agente IA <br>para empresas.
              </SectionTitleTwo>

              <p class="mb-4 text-light mx-md-auto mx-lg-0 parrafos">
                Consulta tarifas y promociones disponibles.
              </p>
    ...
    <BenefitsBar class="pt-4 benefits-hidden-medium" :items = "benefitsAgenteIA.benefits" />
...
<style scoped>
.sms-banner {
  background-image: url("/img/soluciones/IMAGEN_1_SECCION_5.png");
